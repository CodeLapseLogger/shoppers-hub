...
class ShoppingApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider.value( // ChangeNotifierProvider is to setup the provider: ProductsProvider in the 
      ...
      value: ProductsProvider(), // This is an instance of the provider and not a widget.
      child: MaterialApp(
        title: 'Shoppers Hub',
        theme: ThemeData(
